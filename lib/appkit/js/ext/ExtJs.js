...
AppKit.Ext = function() {
	...
	return {
		...
		stateProvider: function() {
			if (!oStateProvider) {
				oStateProvider = new Ext.ux.state.HttpProvider({
					url: '/web/cronks/persistenceProvider/json',
					method: 'post',
...
Ext.onReady(function(){
	...
	Ext.state.Manager.setProvider(AppKit.Ext.stateProvider());
