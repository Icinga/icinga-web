       ...
       userGridCmp = new Ext.grid.GridPanel({
            ...
            colModel: new Ext.grid.ColumnModel({
                ...
                columns: [
                    ...
                    {header: _('username'), dataIndex: 'name'},
                    ...
                    {   
                        ...
                        handler:  function(b) {
                            ...
                            AppKit.Admin.UserEditForm.saveUser(
                                ...
                                function() {
                                    Ext.getCmp('progressbar-field').setValue(
                                        "<span style='color:green;margin:4px;'>"+_("User saved successfully")+"</span>"
                                    );
                                ...
                                function() {
                                    Ext.getCmp('progressbar-field').setValue(
                                        "<span style='color:red;margin:4px;'>"+_("Couldn't save user, review your settings")+"</span>"
                                    );
                                    b.setIconClass('icinga-icon-disk');
                                    b.setText(_("Retry"));
                                    b.setDisabled(false);
