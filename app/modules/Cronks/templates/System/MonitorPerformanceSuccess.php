    ...
    var mTpl = new Ext.XTemplate(
            ...
            '<div class="icinga-monitor-performance-container-50">',
                ...
                '<div class="clearfix icinga-monitor-performance-container">',
                    ...
                    '<tpl if="HOST_LATENCY_AVG &gt; '+hostThreshold+'"><span style="color:red" ext:qtip="Threshold reached"> {HOST_LATENCY_AVG} </span></tpl>',
            ...
            '<div class="icinga-monitor-performance-container-50">',
                ...
                '<div class="clearfix icinga-monitor-performance-container">',
                    ...
                    '<tpl if="SERVICE_LATENCY_AVG &gt; '+serviceThreshold+'"><span style="color:red" ext:qtip="Threshold reached"> {SERVICE_LATENCY_AVG} </span></tpl>',
