...
IcingaCommandHandler.prototype = {
    ...
    enhanceToolbar: function () {
        ...
        if (Ext.isEmpty(this.command_options.items)) this.toolbaritem.menu.add({
            xtype: 'tbtext',
        ...
        Ext.Ajax.request({
            ...
            success: function (response, opts) {
                ...
                Ext.each(o.fields, function (item, index, arry) {
                    ...
                    if (item == "author") this.command_options.predefined[item] = AppKit.getPreferences()["author_name"];
                    var f = this.getField({
                        fieldLabel: item,
                        fieldName: item,
