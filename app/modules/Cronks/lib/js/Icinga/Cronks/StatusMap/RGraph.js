...
(function () {
    ...
    var jitAddEvent = function (obj, type, fn) {
    ...
    Icinga.Cronks.StatusMap.RGraph = function (config) {
        ...
        this.jitInit = function (json, elementIds) {
            ...
            var detailHandler = (function (domElement, node) {
                domElement.innerHTML = node.name;

                Ext.get(domElement).on('click', function () {
                    rgraph.onClick(node.id);
                    this.applyCronkEventHandler(this.elementIds.jitDetails);
                }, this);
        ...
        this.applyCronkEventHandler = function (id) {
            var ele = Ext.get(id);
        ...
        this.getMapDataSuccess = function (response, o) {
            ...
            this.jitInit(this.jitJson, this.elementIds);
            this.mask.hide();
            this.mask.disable();
        };
