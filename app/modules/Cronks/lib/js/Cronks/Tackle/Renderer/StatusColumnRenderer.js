//Ext.ns('Icinga.Cronks.Tackle.Renderer').StatusColumnRenderer = function(value, metaData, record, rowIndex, colIndex, store) {
//
...
//                                fn: function(btn) {if(btn == "yes") alert("Implement me!")}
//                            });
//                        },this);
//                    },this);
