...
/* Creation date: 2012-04-26T15:57:56+02:00          */
/****************************************************/
...
INSERT INTO nsm_target (target_id,target_name,target_description,target_class,target_type) VALUES ('9','appkit.admin.groups',' to group related data (e.g. share cronks)','','credential');
